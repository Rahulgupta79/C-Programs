...
{
	int choice;
	printf("\n\n\n Enter choice accordingly and press number\n[0]---->Exit\n[1]---->Create an array\
	\n[2]---->Insert\n[3]---->Display\n[4]---->Linear Search\n[5]---->binary search\
	\n[6]---->delete\n[7]---->To sort\n Enter your choice ");
	 scanf("%d",&choice);
	 return choice;
...
/*Selection sort
 ...
 ADT-for selection sort
purpose:-to sort the elements of the array in the ascending order
pre:-array is connected
input:-array(int),length(int)
output:-array(int)
post:-elements are sorted
*/
